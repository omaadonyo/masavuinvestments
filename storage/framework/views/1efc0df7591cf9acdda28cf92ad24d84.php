...
">
    ...
    <div style="
        ...
        gap: 20px;
    ">
        <img src="<?php echo e(Storage::url($record->avatar_url) ?? 'https://ui-avatars.com/api/?name=' . urlencode($record->full_name)); ?>"
             style="
                width: 90px;
                height: 90px;
                border-radius: 50%;
        ...
        <div style="grid-column: span 2; background:#f9fafb08; padding:15px; border-radius:12px;">
            ...
            <div style="margin-top:10px;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->national_id_photo): ?>
                    <img src="<?php echo e(Storage::url($record->national_id_photo)); ?>"  style="color:#1d4ed8;" />
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($record->current_photo): ?>
                    <br>
                    <img src="<?php echo e(Storage::url($record->current_photo)); ?>" style="color:#1d4ed8;" />
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>

    </div>
</div><?php /**PATH C:\xampp\htdocs\mic-admin\resources\views\filament\pages\actions\user.blade.php ENDPATH**/ ?>