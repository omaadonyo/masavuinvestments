<div style="width: 100%; margin: 0px auto;">
    ...
    <div style="border-radius: 16px; padding: 0px;">
        ...
        <div>
            ...
            <p style="margin: 3px 0 0;">
                <img src="<?php echo e(Storage::url($record->payment_proof)); ?>">
            </p>
        </div>
...
</div><?php /**PATH C:\xampp\htdocs\mic-admin\resources\views\filament\pages\actions\contributions.blade.php ENDPATH**/ ?>