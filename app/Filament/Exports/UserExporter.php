...
class UserExporter extends Exporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('place_of_residence'),
            ExportColumn::make('name'),
            ExportColumn::make('email'),
            ExportColumn::make('phone_number'),
            ExportColumn::make('national_id_passport_number'),
            ExportColumn::make('source_of_income'),
            ExportColumn::make('next_of_kin_name'),
            ExportColumn::make('relationship_next_of_kin'),
            ExportColumn::make('contacts_next_of_kin'),
            ExportColumn::make('active_bank_account_name'),
            ExportColumn::make('active_bank_account_number'),
