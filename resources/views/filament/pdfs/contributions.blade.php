...
<table>
    ...
    <td class="card">
        <h4>Total Amount</h4>
        <p>UGX {{ number_format($contributions->sum('amount'), 0) }}</p>
    </td>
    <td class="card">
        <h4>Total Deposits</h4>
        <p>UGX {{ number_format($contributions->sum('total_deposit'), 0) }}</p>
    </td>
    <td class="card">
        <h4>Active Users</h4>
        <p>{{ $contributions->pluck('user_id')->unique()->count() }}</p>
    </td>
</table>
...
<table>
    ...
    <tfoot>
        <tr>
            ...
            <td class="right">UGX {{ number_format($contributions->sum('amount'), 0) }}</td>
            <td class="right">{{ number_format($contributions->sum('managment_fee'), 0) }}</td>
...
<!-- FOOTER -->
<div class="footer">
    © {{ date('Y') }} Masavu Investment Club — Confidential Report 2026
</div>
