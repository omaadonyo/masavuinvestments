...
<table>
    ...
    <tbody>
        ...
        @foreach ($transactions as $index => $txn)
            ...
            <tr>
                <td  style="width:15px;" class="center">{{ $index + 1 }}</td>
                <td>{{ $txn->txn_id }}</td>
                <td>{{ $txn->txn_reference }}</td>
                <td style="width:60px;">{{ $txn->user->name ?? '-' }}</td>
                <td  style="width:50px;"class="center">{{ $txn->txn_type }}</td>

                <td  style="width:60px;"class="right">UGX {{ number_format($txn->amount, 0) }}</td>
                <td  style="width:55px;" class="right">UGX {{ number_format($txn->total_deposit, 0) }}</td>
                ...
                <td style="width:80px;">{{ $txn->notes ?? '-' }}</td>
    ...
    <tfoot>
        <tr>
            ...
            <td class="right">UGX {{ number_format($totalAmount, 0) }}</td>
            <td class="right">UGX {{ number_format($totalDeposit, 0) }}</td>
            <td class="right">{{ number_format($totalMgmt, 0) }}</td>
            <td class="right">{{ number_format($totalReturn, 0) }}</td>
            <td colspan="6"></td>
        </tr>
    </tfoot>
</table>
...
<!-- FOOTER -->
<div class="footer">
    © {{ date('Y') }} Masavu Investment Club — Transactions Report
</div>
