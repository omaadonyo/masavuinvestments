...
<body>
            ...
            <div class="hero-grid">
                ...
                <div class="animate-on-scroll">
                    ...
                    <div class="flex gap-4" style="flex-wrap: wrap;">
                        <a href="{{ $landing->hero_primary_cta_link }}" class="btn btn-primary">
                        ...
                        <a href="{{ $landing->hero_secondary_cta_link }}" class="btn btn-outline">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <div class="portfolio-header">
                            ...
                            <div>
                                ...
                                <p class="portfolio-value">
                                    UGX {{ number_format($totalContribution) }}
                                </p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="stats-grid">
                <div class="stat-item animate-on-scroll">
                    ...
                    <div class="stat-number" data-count="{{ $totalUsers }}" data-suffix="+">0</div>
                ...
                <div class="stat-item animate-on-scroll">
                    ...
                    <div class="stat-number" data-count="{{ $totalContribution }}" data-prefix="UGX " data-format="compact">0</div>
    ...
    <section id="features" class="section">
        <div class="container">
            <div class="text-center animate-on-scroll">
                ...
                <h2 class="section-title">{{ $landing->features_title }}</h2>
                <p class="subtitle">{{ $landing->features_subtitle }}</p>
            </div>
            ...
            <div class="grid-3" style="margin-top: 3rem;">
                ...
                <div class="card animate-on-scroll">
                    <div class="card-icon">
                        @if($landing->feature1_icon == 'briefcase')
                    ...
                    <h3 class="card-title">{{ $landing->feature1_title }}</h3>
                    <p>{{ $landing->feature1_description }}</p>
                </div>

                <!-- Feature 2 -->
                <div class="card animate-on-scroll">
                    <div class="card-icon">
                        @if($landing->feature2_icon == 'chart-bar')
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <h3 class="card-title">{{ $landing->feature2_title }}</h3>
                    <p>{{ $landing->feature2_description }}</p>
                </div>

                <!-- Feature 3 -->
                <div class="card animate-on-scroll">
                    <div class="card-icon">
                        @if($landing->feature3_icon == 'puzzle-piece')
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <h3 class="card-title">{{ $landing->feature3_title }}</h3>
                    <p>{{ $landing->feature3_description }}</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid-3" style="margin-top: 3rem;">
                ...
                <div class="project-card animate-on-scroll">
                    <div class="project-image-wrapper">
                        <img src="{{ Storage::url($project->photos[1]) }}" alt="Real Estate Development" class="project-image">
                        <span class="project-badge">Active Investment</span>
                    </div>
                    <div class="project-body">
                        <h3 class="card-title">{{ $project->title }}</h3>
                        <p style="color:#000;" class="text-muted">{{ $project->description }}</p>
                    </div>
                </div>
    ...
    <section class="section section--white">
        <div class="container">
            <div class="text-center animate-on-scroll">
                <span class="badge">{{ $landing->howitworks_badge }}</span>
                <h2 class="section-title">{{ $landing->howitworks_title }}</h2>
                <p class="subtitle">{{ $landing->howitworks_subtitle }}</p>
            </div>
            ...
            <div class="steps-grid" style="margin-top: 3rem;">
                ...
                <div class="step-card animate-on-scroll">
                    ...
                    <h3 class="card-title">{{ $landing->step1_title }}</h3>
                    <p style="color:#000;" class="text-muted">{{ $landing->step1_description }}</p>
                ...
                <div class="step-card animate-on-scroll">
                    ...
                    <h3 class="card-title">{{ $landing->step2_title }}</h3>
                    <p style="color:#000;" class="text-muted">{{ $landing->step2_description }}</p>
                    <div class="step-arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2">
                            <line x1="5" y1="12" x2="19" y2="12"></line>
                            <polyline points="12 5 19 12 12 19"></polyline>
                ...
                <div class="step-card animate-on-scroll">
                    ...
                    <h3 class="card-title">{{ $landing->step3_title }}</h3>
                    <p style="color:#000;" class="text-muted">{{ $landing->step3_description }}</p>
                    <div class="step-arrow">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2">
                            <line x1="5" y1="12" x2="19" y2="12"></line>
                            <polyline points="12 5 19 12 12 19"></polyline>
                ...
                <div class="step-card animate-on-scroll">
                    ...
                    <h3 class="card-title">{{ $landing->step4_title }}</h3>
                    <p style="color:#000;" class="text-muted">{{ $landing->step4_description }}</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="faq" class="section section--warm">
        <div class="container">
            <div class="text-center animate-on-scroll">
                ...
                <h2 style="color:#000;" class="section-title">{{ $landing->faq_title }}</h2>
                <p style="color:#000;" class="subtitle">{{ $landing->faq_subtitle }}</p>
            </div>
            ...
            <div class="faq-list" style="margin-top: 3rem;">
                ...
                <div class="faq-item animate-on-scroll">
                    <div class="faq-question" onclick="toggleFaq(this)">
                        <span>{{ $landing->faq1_question }}</span>
                ...
                <div class="faq-item animate-on-scroll">
                    <div class="faq-question" onclick="toggleFaq(this)">
                        <span>{{ $landing->faq2_question }}</span>
                        <svg class="faq-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="6 9 12 15 18 9"></polyline>
                        </svg>
                    </div>
                    <div class="faq-answer">
                        <p>{{ $landing->faq2_answer }}</p>
                    </div>
                </div>
                ...
                <div class="faq-item animate-on-scroll">
                    <div class="faq-question" onclick="toggleFaq(this)">
                        <span>{{ $landing->faq3_question }}</span>
                        <svg class="faq-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="6 9 12 15 18 9"></polyline>
                        </svg>
                    </div>
                    <div class="faq-answer">
                        <p>{{ $landing->faq3_answer }}</p>
                    </div>
                </div>
                ...
                <div class="faq-item animate-on-scroll">
                    <div class="faq-question" onclick="toggleFaq(this)">
                        <span>{{ $landing->faq4_question }}</span>
                        <svg class="faq-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2">
                            <polyline points="6 9 12 15 18 9"></polyline>
                        </svg>
                    </div>
                    <div class="faq-answer">
                        <p>{{ $landing->faq4_answer }}</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div style="margin-top: 2rem;">
                        ...
                        <div class="contact-info-item">
                            ...
                            <div>
                                ...
                                <p class="contact-value">{{ $landing->contact_phone }}</p>
                            </div>
                        </div>
                        ...
                        <div class="contact-info-item">
                            ...
                            <div>
                                ...
                                <p class="contact-value">
                                    <a href="mailto:{{ $landing->contact_email }}">
                        ...
                        <div class="contact-info-item">
                            ...
                            <div>
                                ...
                                <p class="contact-value">{{ $landing->contact_address }}</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="grid-4" style="gap: 3rem;">
            ...
            <div class="footer-links">
                <h4>Quick Links</h4>
                <ul>
                    <li><a href="#features">{{ $landing->quicklink1 }}</a></li>
                    <li><a href="#projects">{{ $landing->quicklink2 }}</a></li>
                    <li><a href="#faq">{{ $landing->quicklink3 }}</a></li>
                    <li><a href="#contact">{{ $landing->quicklink4 }}</a></li>
                </ul>
            </div>
            ...
            <div class="footer-links">
                <h4>Legal</h4>
                <ul>
                    <li><a href="#">{{ $landing->legallink1 }}</a></li>
                    <li><a href="#">{{ $landing->legallink2 }}</a></li>
                    <li><a href="#">{{ $landing->legallink3 }}</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="footer-bottom">
            <p>
                &copy; {{ date('Y') }} {{ $landing->footer_brand }}. All rights reserved.
            </p>
        </div>
    </div>
</footer>
